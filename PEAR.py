...
if __name__ =='__main__':
    ...
    if type(args.input) == type(list()): SET = set_collection(args.input, args.output, args.distance_matrix, args.metadata) 
    else: SET = tree_set(args.input, args.output, args.distance_matrix, args.metadata)

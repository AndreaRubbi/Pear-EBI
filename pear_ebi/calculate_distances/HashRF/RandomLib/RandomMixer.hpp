 ...
 * systematic fashion to produce a set of uncorrelation random number
 * sequences.
 *
...
namespace RandomLib {
   ...
   *
   * The template parameter \a RandomType switches between the 32-bit and
   * 64-bit versions.
   *
   ...
   * perferably, MixerSFMT should be used.
   **********************************************************************/

  template<class RandomType> class MixerMT0 {
  public:
    /**
  ...
  private:
    static const mixer_type a0 = 5489ULL, a1 = 19650218UL,
  ...
  template<class RandomType> class MixerMT1 {
  public:
    /**
     * The RandomType controlling the output of MixerMT1::SeedToState
     **********************************************************************/
   ...
   * and is part of the C++0X proposal; see P. Becker, Working Draft, Standard
  ...
  public:
     ...
     * Return the name of this class.
     **********************************************************************/
    static std::string Name() throw() { return "MixerSFMT"; }
  private:
    static const mixer_type a = 0x8b8b8b8bUL, b = 1664525UL, c = 1566083941UL;
  };

} // namespace RandomLib

#endif	// RANDOMMIXER_HPP

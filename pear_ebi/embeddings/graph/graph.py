...
def plot_embedding(data, metadata, dimensions, save=False, name_plot='Tree_embedding', static=False, plot_meta = 'SET-ID', plot_set = None, select = False, same_scale = False):
    ...
    for meta in metadata.columns: # for each metadata column
        ...
        colorscales_cmap = ['Accent', 'Blues', 'BrBG', 'BuGn', 'BuPu', 'CMRmap', 'Dark2',
                       ...
                       'hsv', 'inferno', 'jet', 'magma', 'nipy_spectral', 'ocean', 'pink',
                       'plasma', 'prism', 'rainbow', 'seismic', 'spring', 'summer', 
                       'tab10', 'tab20', 'tab20b', 'tab20c', 'terrain', 'turbo', 'twilight',
        ...
        colorscales_GO = ['aggrnyl', 'agsunset', 'algae', 'amp', 'armyrose', 'balance',
        ...
        colorscales_GO = ['blues', 'darkmint', 'gray', 'greens', 'greys',
             'hot', 'ice', 'magenta', 'mint', 'oranges', 'peach',
             'purples', 'reds']
        ...
        cont_colorsc = False
        if len(elements) > 10: cont_colorsc = True 
        ...
        for i, SetID in enumerate(Sets):
            ...
            if cont_colorsc: col_list = random.sample(colorscales_GO, 1)[0] if not same_scale else 'jet'
            color = col_list
                ...
                for i,ID in enumerate(Sets):
                    ...
                    buttons_ID.append(dict(type="buttons",
                                        ...
                                        buttons=list([
                                            ...
                                            xanchor="left",
                                            y=(1.2)+ 0.13*(i - nUnique//2 * int(round((i+1)/(nUnique)))) - 0.06*(i - nUnique//2 * int(round((i+1)/(nUnique)))),
                ...
                for i,ID in enumerate(Sets):
                    ...
                    buttons_ID.append(dict(type="buttons",
                                        ...
                                        buttons=list([
                                            ...
                                            xanchor="left",
                                            y=(1.50)+ 0.10*(i - nUnique//2 * int(round((i+1)/(nUnique)))) - 0.04*(i - nUnique//2 * int(round((i+1)/(nUnique)))),
                                            yanchor="top"),
                                    )

import random, sys, os, inspect
from multiprocessing import Process, Manager
import numpy as np
try: from ..calculate_distances import maple_RF 
except: 
        ...
        while len(interesting_points) < n_required:
            ...
            if d_MD1_P > d_MD1_MD2:
                ...
                if random.randint(0, 10) > 5:
                    MD2_sub, MD2_prep_sub = P, maple_RF.prepareTreeComparison(P, rooted=False)
                    ...
                    MD1_sub, MD1_prep_sub = P, maple_RF.prepareTreeComparison(P, rooted=False)
